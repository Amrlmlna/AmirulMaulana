    ...
    <main className="bg-black min-h-screen text-white pt-24 md:pt-32">
      ...
      <section className="px-4 md:px-12 mb-32">
         <div className="max-w-7xl mx-auto">
            ...
            {/* Action Buttons */}
            {(project.githubUrl || project.downloadUrl || project.liveUrl) && (
                <motion.div
                ...
                >
                    {project.liveUrl && (
                        <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-3 bg-white text-black border border-white px-6 py-3 hover:bg-neutral-200 transition-all">
                             <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path><polyline points="15 3 21 3 21 9"></polyline><line x1="10" y1="14" x2="21" y2="3"></line></svg>
                             <span className="font-mono text-xs tracking-widest">VISIT_SITE</span>
                        </a>
                    )}
                    {project.downloadUrl && (
